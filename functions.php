<?php
/**
 * DevTSK functions and definitions
 *
...
if ( ! function_exists( 'devtsk_setup' ) ) :
	/**
	 ...
	 */
	function devtsk_setup() {
		/*
		 * Make theme available for translation.
		 * Translations can be filed in the /languages/ directory.
		 * If you're building a theme based on DevTSK, use a find and replace
		 * to change 'devtsk' to the name of your theme in all the template files.
		 */
		load_theme_textdomain( 'devtsk', get_template_directory() . '/languages' );
		...
		add_theme_support( 'custom-background', apply_filters( 'devtsk_custom_background_args', array(
